...
class ReclamationController extends AbstractController
{
    ...
    #[Route('/chats/{id}', name: 'app_reclamation_chat', methods: ['GET'])]
    public function chatAdmin(Request $request, Reclamation $reclamation): Response
    {
        
        return $this->render('reclamation/chatAdmin.html.twig', [
            'reclamation' => $reclamation,
